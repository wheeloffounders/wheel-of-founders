...
export interface EnergyTrendsCelebrationProps {
  isOpen: boolean
  onClose: () => void
}
...
export function EnergyTrendsCelebration({ isOpen, onClose }: EnergyTrendsCelebrationProps) {
  ...
  const sparklePositions = useMemo(
    () => [
      { top: '8%', left: '20%', delay: 0.0 },
      { top: '10%', left: '65%', delay: 0.12 },
      { top: '22%', left: '82%', delay: 0.28 },
      { top: '38%', left: '12%', delay: 0.22 },
      { top: '55%', left: '90%', delay: 0.34 },
      { top: '72%', left: '25%', delay: 0.44 },
    ],
    []
  )
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 id="energy-trends-title" className="text-2xl font-bold text-[#152B50] dark:text-white mb-2">
              Energy &amp; Mood Trend Unlocked 📊
            </h2>

            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
              From day 2 (or your 3rd evening reflection), Mrs. Deer can start mapping your energy and mood.
            </p>

            <div className="bg-[#152b50]/5 dark:bg-[#152b50]/20 border-l-4 border-[#ef725c] rounded-lg p-4 mb-5 text-left">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                You&apos;re now able to see how your <span className="font-semibold">mood</span> and <span className="font-semibold">energy</span> shift over time.
              </p>
              <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 list-disc list-inside mt-3">
                <li>Spot the days that drain you vs. those that fuel you</li>
                <li>Notice what you did right after your mood dips</li>
                <li>Build a “repeatable win” for your next week</li>
              </ul>
            </div>
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Your next reflection adds another point to the chart — and sharpens the pattern.
              </p>
            </div>
            ...
            <div className="mt-2">
              <Button
                ...
                onClick={() => {
                  onClose()
                  router.push('/founder-dna/rhythm')
                }}
              >
                See your chart →
              </Button>
