...
type FounderDnaPageShellProps = {
  title: string
  description?: string
  /** Wider content rail for split-pane diagnostic layouts (e.g. archetype). */
  wide?: boolean
  children: ReactNode
}

/** Consistent header + scrollable content area for Founder DNA hub pages. */
export function FounderDnaPageShell({ title, description, wide = false, children }: FounderDnaPageShellProps) {
  return (
    <div className="w-full min-h-[50vh]">
      <div
        className={wide ? 'max-w-6xl mx-auto px-4 md:px-5 py-6 pb-28' : 'max-w-4xl mx-auto px-4 md:px-5 py-6 pb-28'}
      >
