      ...
      {insights.length > 0 ? (
        <div className="space-y-4">
          {insights.map((insight, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-800 rounded-lg p-5 border-l-4 border-blue-500 shadow-sm"
            >
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-0.5 text-2xl">👥</div>
                <div className="flex-1">
                  <p className="text-gray-900 dark:text-gray-100 leading-relaxed mb-2">{insight.insight_text}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center border-2 border-dashed border-blue-300">
          <Users className="w-12 h-12 text-blue-400 mx-auto mb-3" />
          <p className="text-gray-700 dark:text-gray-300 mb-2">Community insights will appear after analysis</p>
