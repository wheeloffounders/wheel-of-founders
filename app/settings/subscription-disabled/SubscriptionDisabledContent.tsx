...
export default function SubscriptionDisabledContent() {
    ...
    return (
      <div className="max-w-2xl mx-auto px-4 md:px-5 py-8">
        <div className="flex items-center justify-center py-12">
          <Loader className="w-8 h-8 animate-spin text-gray-900 dark:text-gray-100" />
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 md:px-5 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700 dark:text-gray-300">Manage your subscription and billing</p>
      </div>

      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Current Plan</h2>

        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-lg">
            <div>
              <p className="font-semibold text-gray-900 dark:text-gray-100 capitalize">{subscription?.tier || 'Free'}</p>
            ...
            <div className="flex items-center gap-2">
              {isActive ? (
                ...
                <span className="px-3 py-1 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-full text-sm font-medium flex items-center gap-1">
            ...
            <>
              {subscription.subscription_started_at && (
                <div className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <Calendar className="w-5 h-5 text-gray-500 dark:text-gray-500" />
                  <div>
                    <p className="text-sm text-gray-700 dark:text-gray-300">Started</p>
      ...
      <div className="space-y-4">
        ...
        {subscription?.tier === 'free' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Upgrade Your Plan</h3>
        ...
        {subscription?.stripe_subscription_id && isActive && !isCanceled && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Manage Subscription</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        {subscription?.stripe_subscription_id && isCanceled && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Reactivate Subscription</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
