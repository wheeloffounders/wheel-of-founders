...
const pricingTiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      'Everything in Free',
      'Full Mrs. Deer, your AI companion coach (5 prompts)',
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        {currentTier !== 'beta' && (
          <div className="mt-6 flex items-center justify-center gap-4">
            ...
            <span className={`text-sm font-medium ${billingPeriod === 'annual' ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-500'}`}>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className={`p-2 rounded-lg ${tier.highlight ? 'bg-[#ef725c]/10' : 'bg-gray-50 dark:bg-gray-900'}`}>
                  <div className={tier.highlight ? 'text-[#ef725c]' : 'text-gray-700 dark:text-gray-300'}>
                    {tier.icon}
                  </div>
                </div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{tier.name}</h2>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-2">
                  ...
                  {tier.monthlyOption && (
                    <span className="text-sm text-gray-500 dark:text-gray-500">or {tier.monthlyOption}</span>
                  )}
                </div>
                {tier.billed && <p className="text-sm text-gray-500 dark:text-gray-500 mt-1">{tier.billed}</p>}
              </div>
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Frequently Asked Questions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Is my data stored forever?</h3>
          ...
          <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">What happens during beta?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">What do I get with Pro?</h3>
            <p className="text-gray-700 dark:text-gray-300 text-sm">
              Pro unlocks full Mrs. Deer, your AI companion coaching (all 5 prompts), smart constraint insights, unlimited history with
