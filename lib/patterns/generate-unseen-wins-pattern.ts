...
/**
 * AI “Unseen Wins” pattern from last 14 days of evening data (same output as POST /api/patterns/generate).
 * Persist to `weekly_insights` via POST /api/founder-dna/unseen-wins/refresh (Rhythm page).
 */
export async function generateUnseenWinsPatternForUser(userId: string): Promise<string | null> {
