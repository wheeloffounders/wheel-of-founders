...
Ready to stop the fog? Mrs. Deer is pre-configured with the EOS loop.

<InteractiveTemplate context="eos" />
...
<BlogCTA
  context="eos"
  title="EOS / Planning"
  text="Theory is great, but execution wins. Launch your first EOS cycle in 60 seconds."
  buttonLabel="Execute Like a Pro"
/>
