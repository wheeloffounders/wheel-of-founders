...
<div className="my-10 flex flex-col gap-6">
  <InteractiveTemplate
    ...
    title="Set your 7 PM shutdown line"
    subtitle="You just learned the Evening Reset — now name what 'finished enough' looks like tonight so you can close the laptop and mean it."
  />

  <BlogCTA
    funnel="finished_enough_toggle"
    variant="inline"
    title="Hold the line tonight"
    text="Mrs. Deer saves your shutdown logic and brings it back on tomorrow's Morning Canvas."
...
<BlogCTA
  funnel="finished_enough_toggle"
  title="Evening closure, systematized"
  text="Stop re-deciding your shutdown every night. Let Mrs. Deer hold your 7 PM boundary."
