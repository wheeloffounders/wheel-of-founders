...
### Try the handoff stress-test

Before you write the checklist, run one task through limb-vs-baby triage—Mrs. Deer reflects back what your fear is actually claiming.

<InteractiveTemplate context="delegation_stress_test" />
...
<BlogCTA funnel="delegation_stress_test" buttonLabel="Claim my delegation mirror" />
